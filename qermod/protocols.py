...
class AmplitudeDamping(PrimitiveNoise):
    ...
    protocol: NoiseCategoryEnum = Field(default=NoiseCategory.DIGITAL.AMPLITUDE_DAMPING, frozen=True)
...
class GeneralizedAmplitudeDamping(PrimitiveNoise):
    ...
    protocol: NoiseCategoryEnum = Field(default=NoiseCategory.DIGITAL.GENERALIZED_AMPLITUDE_DAMPING, frozen=True)
